...
│  │  │  │           ALB                      │                   │    │  │
│  │  │  │                                   │                   │    │  │
│  │  │  │  api.devworld.com     → :3000     │ ◄── HTTPS (:443) │    │  │
│  │  │  │  airflow.devworld.com → :8080     │     + ACM 인증서  │    │  │
│  │  │  └───────────────┬───────────────────┘                    │    │  │
│  │  │                  │                                        │    │  │
│  │  │  ┌───────────────┘        ┌──────────────────────┐       │    │  │
...
│   ├── Desired Count: 1
│   └── ALB Target Group: api.devworld.com → :3000
│
...
│   ├── Desired Count: 1
│   └── ALB Target Group: airflow.devworld.com → :8080
│
...
└────┬────┘
     │  :3000 (Nest.js) / :8080 (Airflow)
     ▼
┌─────────┐
│   ECS   │  ← ECS Security Group
│         │     인바운드: ALB에서만 :3000, :8080
└────┬────┘
     │  :5432
     ▼
┌─────────┐
